    ...
    <MainLayout>
        ...
        <div class="max-w-[880px] lg:ml-0 md:ml-[80px] md:pl-20 px-4 w-[100vw]">
            <div class="flex items-center md:justify-between">
                <label for="fileUser">
                    <img class="rounded-full object-fit md:w-[200px] w-[100px] cursor-pointer" :src="user.file">
                </label>
                <input
                ...
                <div class="ml-6 w-full">
                    <div class="flex items-center md:mb-8 mb-5">
                        ...
                        <button class="md:block hidden md:mr-6 p-1 px-4 rounded-lg text-[16px] font-bold bg-white hover:bg-gray-200 border-b border-b-gray-200">
                            Edit Profile
                        </button>
                        <Cog :size="28" class="cursor-pointer"/>
                    </div>
                    <button class="md:hidden mr-6 p-1 px-4 max-w-[260px] w-full rounded-lg text-[17px] font-bold bg-white hover:bg-gray-200 border-b border-b-gray-200">
                        Edit Profile
                    </button>
                    <div class="md:block hidden">
                        <div class="flex items-center text-[18px]">
                            <div class="mr-6">
                                <span class="font-bold pr-1">{{ postsByUser.data.length }}</span>posts
                            </div>
                            <div class="mr-6">
                                <span class="font-bold pr-1">123</span>followers
                            </div>
                            <div class="mr-6">
                                <span class="font-bold pr-1">456</span>following
                            </div>
                        </div>
                    </div>
        ...
        <div class="md:hidden">
            <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
                <div class="text-center p-3">
                    <div class="font-bold">{{ postsByUser.data.length }}</div>
                    <div class="text-gray-400 font-bold -mt-1.5">posts</div>
                </div>
                <div class="text-center p-3">
                    <div class="font-bold">43</div>
                    <div class="text-gray-400 font-bold -mt-1.5">followers</div>
                </div>
                <div class="text-center p-3">
                    <div class="font-bold">55</div>
                    <div class="text-gray-400 font-bold -mt-1.5">following</div>
                </div>
            </div>
            
            <div class="w-full flex item-center justify-between border-t border-t-gray-300">
        ...
        <div id="ContentSection" class="md:pr-1.5 lg:pl-0 md:pl-[90px]">
            <div class="md:block mt-10 hidden border-t border-t-gray-300">
                <div class="flex items-center justify-between max-w-[600px] mx-auto font-bold text-gray-400 text-[15px]">
