...
<template>
    ...
    >
        <div
            ...
            class=" absolute w-full h-full z-50 flex items-center justify-around text-lg font-bold text-white"
        >
        ...
        <img 
        class="aspect-square mx-auto z-0 ovject-cover cursor-pointer"
        :src="postByUser.file"
        >
    </div>
</template>
